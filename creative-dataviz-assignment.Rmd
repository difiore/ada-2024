---
title: "Creative Data Visualization Assignment"
---
...
Your visualization does not have to be sophisticated, but it must involve loading, transforming, and visualizing a custom dataset - either a publicly-available one you find or one relevant to your own work or your field of study - into some kind of interesting, creative representation. Mostly, I am looking for you try to be **creative** and think outside the box in how to represent data... and to that end, it would be okay if you simply want to present a cool algorithm/protocol/description about how you would like to transform your data even if you are not able to implement it.
...
If your visualization cannot be done entirely with code (i.e., if you produce "something else" with your data after wrangling/transforming with code: a recording, painting, physical object, text or graphic representation of a process/algorithm for visualization that you cannot yet implement), please follow the same instructions above, but then also take a photo/video/recording of your finished product or a sketch of your (unrealized) ideas and include it in your knitted ".Rmd" file.

> **NOTE:** I should be able to CLONE whatever is in your repository and knit your associated ".Rmd" file to show all of the work for this creative data visualization.
