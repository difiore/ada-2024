...
```{r}
f <- "https://raw.githubusercontent.com/difiore/ada-2022-datasets/main/Bowden-ParryOtterdata.csv"
d <- read_csv(f, col_names = TRUE)
head(d)
library(glmmML)
```
