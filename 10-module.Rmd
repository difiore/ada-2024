...
# Data Wrangling with {dplyr} {#module-10}

## Objectives

> The objective of this module to introduce you to data wrangling using the {dplyr} package, which is part of the {tidyverse} family.
...
The {dplyr} package, included in the {tidyverse}, provides "a flexible grammar of data manipulation" that makes many of the manipulations that we explore in [**Module 07**](#module-07) and [**Module 09**](#module-09) much easier and muchmore intuitive!
