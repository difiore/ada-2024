...
compare_SEs <- tibble(
  ...
  "samp_dist_mean" = samp_dist_summary$samp_dist_mean,
  "**Samp Dist SD**" = samp_dist_summary$samp_dist_sd,
  "SE from Pop SD" = t(pop_sds/sqrt(n)) |> round(3),
  "**Samp 1 SE**" = samp_1_summary$samp_1_se,
