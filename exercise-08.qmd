...
# this example uses `gf_dist()` simply to create .gg (ggplot) objects rather
# than .trellis (lattice) objects, which makes visualizing the plots together
# using {cowplot} look better
