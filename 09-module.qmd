...
-   GO TO: <https://github.com/difiore/ada-2022-datasets>, select the ".csv" version of the "Country-Data-2016" file, then press the "RAW" button, highlight, and copy the text to a text editor and save it locally. Do the same for the "KamilarAndCooperData" file.
...
f <- "https://raw.githubusercontent.com/difiore/ada-2022-datasets/main/Country-Data-2016.csv"
...
```{r}
# using {base} R
f <- curl("https://raw.githubusercontent.com/difiore/ada-2022-datasets/main/Country-Data-2016.csv")
...
The {psych} package also makes it easy to construct a scatterplot matrix with customizable output.
