...
#### Using the {gdata} package {.unnumbered}
...
# here the [1] reads only the first file from filenames
...
### Importing from ***Google Sheets*** {.unnumbered}
...
More on the basics of using {googlesheets4} for more refined data downloading and formatting can be found [here](https://googlesheets4.tidyverse.org/).
