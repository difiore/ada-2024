...
To calculate R-squared (a.k.a. eta-squared, the amount of variance explained by the model) from the ANOVA table, we calculate the ratio of the regression sum of squares to the total sum of squares.

```{r}
(r2 <- (18.2)/(18.2 + 307.9))
```
> **NOTE:** We could instead run a linear model and recover the equivalent multiple R-squared value directly.
...
summary(m7)
(r2 <- (18.20 + 17.68)/(18.20 + 17.68 + 290.24))
```
...
summary(m8)
(r2 <- (18.20 + 17.68 + 8.41)/(18.20 + 17.68 + 8.41 + 281.83))
```
