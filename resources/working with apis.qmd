...
``` {r echo = FALSE}
app_name <- "My twitteR Access App"
consumer_api_key <- "Fd7uOzBwh40bEJsWFvrKDDyxg"
consumer_secret <- "UOBOzzsCnGNSDzaW0SXPt7h7olYmepfI8mVCwumT8qiHy7CNUB"
bearer_token <- "AAAAAAAAAAAAAAAAAAAAAFPMwwAAAAAAsKfFo2mixjm3b18j4TxYS4%2BwnIk%3Dg2mXm1UXvkZfidkv2dJeipMcshlXfcWnY6ocBBAZJAGeoNGsVT"
access_token <- "145091749-19Fcj4IoOr52P8pqL1DnTxCv2BuxJ4SjQ7grVrUS"
access_secret <- "WkJzStNWYtMQ9E8yz3vICnF6uhg2iEK6ffvlITyq8gRoE"
```
...
```{r}
library(RTwitterV2)
Sys.setenv(BEARER_TOKEN = "AAAAAAAAAAAAAAAAAAAAAFPMwwAAAAAAsKfFo2mixjm3b18j4TxYS4%2BwnIk%3Dg2mXm1UXvkZfidkv2dJeipMcshlXfcWnY6ocBBAZJAGeoNGsVT")
...
consumer_key <- "JIrGtfzAe4Y9FbRz5eAujrEGU"
consumer_secret <- "ebxRX7eEwgN8TtEnkivqexT2rW4ArpSp8U9PmGvRSfdM73LT2W"
```
...
FBtoken <- "EAACEdEose0cBAH2KTvlbpzROI8eC09TJC75eVG18vZAvpDZAXqA5orNPgBXTKSMyWM1RHGZC0wZACn3XZCa27bwQPaKhVqaIUZCibNkYvsZAlYXa0PREPeFNxCygNJTbViqAom813UXKjVkq7CaCtjJVowUg6PaksVkPzeYLlGQxAZDZD"
```
