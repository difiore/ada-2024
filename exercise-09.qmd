...
- Conduct simple linear regression analyses with this dataset where you:
  ...
  -   Generate confidence intervals for regression coefficients and p values for regression coefficients using permuation/bootstrapping methods
...
-   Using the {tidyverse} `read_csv()` function, load the "Street_et_al_2017.csv" dataset from [this URL](https://raw.githubusercontent.com/difiore/ada-2022-datasets/main/Street_et_al_2017.csv) as a "tibble" named **d**.
