...
# (PART\*) Part II - Statistics and Inference {.unnumbered}

# Location, Central Tendency, and Spread {#module-12}
    ...
    for (i in 1:50) # 50 replicates
      {
        ...
        points(n, var(x))
        reps[[i]] = var(x)
        # this is a common programming motif in R and is more memory and
        # time efficient than another common motif, reps <- c(reps, var(x))
      }
