...
The assignment and steps below were inspired by [this fun blog post](https://statisticaloddsandends.wordpress.com/2022/01/18/playing-wordle-in-r/)... but before you reference it or other online sites, try to do tackle this coding exercise on your own.
...
-   Go to <https://github.com/difiore/ada-2022-datasets>, download the following two data files, and add them to your repo:
...
- Create a new **RMarkdown** document, called "wordle.Rmd". In this, you do your best to recreate all of the wordplay used in Wordle.
