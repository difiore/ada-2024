...
-   Using the {tidyverse} `read_csv()` function, load the "AVONETdataset1.csv" dataset from [this URL](https://raw.githubusercontent.com/difiore/ada-2022-datasets/main/AVONETdataset1.csv) as a "tibble" named **d**. This is a recently published dataset that compiles morphological measurements and information on various ecological variables and geographic range data for more than 11,000 species of birds.
