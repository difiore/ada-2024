...
- Create an new **RMarkdown** or **Quarto** document locally with notes you take in class this week - maybe call it "notes.Rmd" or "notes.qmd"? - including at least some expository text written in **Markdown** and at least one ***R*** code block. If you make a ".qmd" document, I recommend unchecking "Use visual markdown editor", though that is your choice.
...
- Use `Knit` (for ".Rmd") or `Render` (for ".qmd") to publish your document as HTML.
...
- Configure a ***GitHub*** Personal Access Token (PAT) and add it to your “.Renviron” file as described in [**Module 6**](#module-06) using the {usethis} package.
